                ...
                setCardType: function(r, e) {
                    ...
                    PagSeguroDirectPayment.getBrand({
                        ...
                        error: function(response) {
                            if (t = 'unknown', !n.hasClass(self.$card, t)) return n.removeClass(self.$card, "jp-card-unknown"), n.removeClass(self.$card, self.cardTypes.join(" ")), n.addClass(self.$card, "jp-card-" + t), n.toggleClass(self.$card, "jp-card-identified", "unknown" !== t), self.cardType = t
                        }
                    });                    
                },
                flipCard: function() {
