...
class Tef extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    {		
        ...
        $info->setAdditionalInformation('tef_bank', $this->pagSeguroHelper->getCCOwnerData('tef_bank'));
       ...
       // $this->pagSeguroHelper->writeLog('getData Order'. print_r($data->getPagseguroproTefBank()));
        ...
        if ($this->pagSeguroHelper->isCpfVisible()) {		
			$this->pagSeguroHelper->writeLog('tef_cpf'. $this->pagSeguroHelper->getCCOwnerData('tef_cpf'));	
			$info->setAdditionalInformation($this->getCode() . '_cpf', $this->pagSeguroHelper->getCCOwnerData('tef_cpf'));
        }
